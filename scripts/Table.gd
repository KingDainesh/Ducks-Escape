...
func body_processing(entered, area, body_rid, body, body_shape_index, local_shape_index):
	print(entered, area, body_rid, body, body_shape_index, local_shape_index)
	print(body.Class)
	if body.Class:
		if str(body.Class) == "Capsule" and entered == true: Capsule = true
		elif str(body.Class) == "Capsule": Capsule = false
		elif str(body.Class) == "Prism" and entered == true: Prism = true
		elif str(body.Class) == "Prism": Prism = false
		elif str(body.Class) == "Box" and entered == true: Box = true
		elif str(body.Class) == "Box": Box = false
